public static class ArraySelector
{
    public static void Run()
    {
        ...
        // Creating more arrays with same length
    ...
    {
        // creating the result array that will hold the selected values

        var result = new int[select.Length];
        var l1Idx = 0;
        var l2Idx = 0;

        // looping through the select array to fill the result array
    ...
    // creating the char version of the ListSelector method
